...
def GenerateAndSend(INVOICE_ID):
    ...
    try:
        ...
        msg['To'] = "leilae@integenx.com;mehrdadn@integenx.com" #leilae@integenx.com;
        ...
        print(e)
s='select INVOICE_NUMBER from ARFIM where INVOICE_DATE=  DATEADD(day, -7, CONVERT (date, SYSDATETIME())) '
